yOSON.AppCore.addModule("range-format", function () {
	...
	st = {
		...
		idNumberFormat: "#js-number-format",
	...
	fn.setFocus = (_element) => { // ingresa el id del input a seleccionar
		//let _input = document.getElementsByClassName(_element);
		let _inputFocus = document.getElementById(_element);
		let focusStart = _inputFocus.selectionStart;
		let focusEnd = _inputFocus.selectionEnd;
